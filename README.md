...
![Platform](https://img.shields.io/badge/Android-8%2B-3DDC84?logo=android&logoColor=white)
![minSdk](https://img.shields.io/badge/minSdk-26-blue)
![Media3](https://img.shields.io/badge/Media3-ExoPlayer-orange)
![Languages](https://img.shields.io/badge/i18n-37%20languages-purple)
![Privacy](https://img.shields.io/badge/Zero%20Cloud-No%20Telemetry-success)

**[Free Demo →](https://vipdashplayer.net)**
...
I started building this in February this year. It began as a side project because none of the existing players did everything I wanted, and over the past few months it kind of escalated into a full product. Now I'm at a point where I'd really appreciate some outside eyes and honest feedback before I push it further. Heads up: there's a lot in there, so this post is going to be long.

## Table of Contents

- [Sources & playlist formats](#sources--playlist-formats)
- [M3U / KodiProp / DRM](#m3u--kodiprop--drm)
- [Playback](#playback)
- [Catchup / Replay](#catchup--replay)
- [EPG](#epg)
- [Recordings & Series](#recordings--series)
- [Network & Privacy](#network--privacy)
- [Channel Preview & Thumbnails](#channel-preview--thumbnails)
- [Remote Web Dashboard](#remote-web-dashboard)
- [UI / Personalization](#ui--personalization)
- [Security & Activation](#security--activation)
...
App runs on **Android 8+ (minSdk 26)** — Android TV, Google TV, Fire TV, Android phones and tablets.
Signed APK, single file, no Play Store dependency.
